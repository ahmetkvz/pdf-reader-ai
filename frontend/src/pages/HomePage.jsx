      ...
      <main className="max-w-2xl mx-auto px-4 py-8 space-y-8">
        <div>
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-colors ${dragOver ? "border-indigo-400 bg-indigo-50" : "border-gray-200 hover:border-indigo-300 hover:bg-gray-50"} ${uploading ? "opacity-60 cursor-not-allowed" : ""}`}
          >
          ...
          {docsLoading ? (
            ...
            <div className="space-y-2">
              {documents.map((doc) => {
                ...
                return (
                  <div key={doc._id} onClick={() => navigate(`/document/${doc._id}`)} className="bg-white border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between cursor-pointer hover:border-indigo-300 hover:bg-gray-50 transition-colors">
